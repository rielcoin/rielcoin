...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/rielcoin-project/rielcoin>";
    const std::string URL_WEBSITE = "<https://rielcoin.org>";
