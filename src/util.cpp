...
const char * const BITCOIN_CONF_FILENAME = "rielcoin.conf";
const char * const BITCOIN_PID_FILENAME = "rielcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "RielCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/RielCoin";
#else
    // Unix
    return pathRet / ".rielcoin";
#endif
#endif
}
