...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s rielcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rielcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rielcoin transaction") + "\n" +
              "  rielcoin-tx [options] -create [commands]   " + _("Create hex-encoded rielcoin transaction") + "\n" +
              "\n";
